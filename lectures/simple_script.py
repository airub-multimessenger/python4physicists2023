...
The first line (`#!/usr/bin/env python`) is seen as a comment by python but as a special directive (shebang) by UNIX/Linux terminals. On a Linux system, you may directly execute the script, assuming it has the execute permission, with ./simple_script.py
